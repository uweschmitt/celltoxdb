...
for cid, cas,name in session.query(Chemical.id,Chemical.cas_number,Chemical.name):
    if cas != "No CAS":
    ...
    info = { "id" : cid, "molecular_weight" : ch_info[idx_num]['molecular_weight']}
...
ml = re.search('[\d\.]+(?=mL)','GUT_jen_24_0024h_AB_m1_FBS00_002mL_nn_in_no_D_16251-77-7').group(0)
short_id = re.sub('_[\d\.]+mL','','GUT_jen_24_0024h_AB_m1_FBS00_002mL_nn_in_no_D_16251-77-7')
